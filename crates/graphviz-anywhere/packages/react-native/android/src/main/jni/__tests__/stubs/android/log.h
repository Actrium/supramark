 ...
 * to stderr, letting graphviz_jni.c compile and run unchanged under
 * scripts/test-android-jni.sh. It is NOT used in any real Android build,
 * which links the genuine NDK <android/log.h>.
 */
